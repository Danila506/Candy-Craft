...
export function Dashboard() {
    const stats = [
        { label: "Всего заказов", value: "1,234", icon: <ShoppingCart />, color: "bg-blue-500" },
        { label: "Всего товаров", value: "89", icon: <Package />, color: "bg-green-500" },
        { label: "Клиенты", value: "2,567", icon: <Users />, color: "bg-purple-500" },
        { label: "Выручка", value: "₽ 1,234,567", icon: <DollarSign />, color: "bg-yellow-500" },
    ];

    const recentOrders = [
        { id: "#00123", customer: "Анна Иванова", date: "12.01.2024", total: "₽ 5,600", status: "Доставлен" },
        { id: "#00122", customer: "Петр Сидоров", date: "11.01.2024", total: "₽ 8,900", status: "В обработке" },
        { id: "#00121", customer: "Мария Петрова", date: "10.01.2024", total: "₽ 3,200", status: "Доставлен" },
        { id: "#00120", customer: "Иван Кузнецов", date: "09.01.2024", total: "₽ 12,500", status: "Отменен" },
    ];
                        ...
                        <table className="w-full">
                            <thead>
                                <tr className="border-b">
                                    ...
                                    <th className="text-left py-3 text-gray-500 font-medium">Сумма</th>
