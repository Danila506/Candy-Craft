...
export function AdminLoginPage() {
  ...
  return (
    <section className="pt-20 px-4 bg-linear-to-b from-rose-50 via-white to-amber-50">
      <div className="mx-auto max-w-lg rounded-2xl border border-gray-100 bg-white/80 backdrop-blur p-6 shadow-sm">
